...
// router.use('/admin/settings', require('./AdminRoutes/settings'));
...
// router.use('/admin/product', require('./AdminRoutes/products'));

// //------------------------------- USERS ------------------------------------
// router.use('/admin/user', require('./AdminRoutes/products'));

// //------------------------------- CUSTOMER ------------------------------------

// router.use('/admin/customer', require('./AdminRoutes/products'));

// //------------------------------- ORDER ------------------------------------
// router.use('/admin/order', require('./AdminRoutes/products'));

// //------------------------------- REVIEWS ------------------------------------
// router.use('/admin/review', require('./AdminRoutes/products'));
